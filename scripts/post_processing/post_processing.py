...
proc_crossings       = 0     # < # Fahrbahnbezogene Eigenschaften von Querungsstellen ermitteln und übertragen                                 # noqa # TODO
proc_cr_markings     = 0     #   # Querungsstellen mit randseitigen Markierungen am Bordstein ausrichten                                       # noqa # TODO
proc_cr_lines        = 0     # < # Linien markierter Gehweg-Querungsstellen erzeugen                                                           # noqa # TODO
proc_cr_tactile_pav  = 0     # < # Taktile Bodenleitsysteme entlang von Bordsteinen und Wegen generieren                                       # noqa # TODO
proc_lane_markings   = 1     # < # Straßenmarkierungen erzeugen                                                                                # noqa # TODO
proc_highway_backup  = 0     # < # Straßenlinien als Backup in fahrbahnfreien Bereichen erzeugen                                               # noqa # TODO
proc_service         = 0     #   # service-Wege mit gleichen Eigenschaften zusammenführen, um Lücken zu vermeiden                              # noqa # TODO
proc_oneways         = 0     #   # Für Einbahnstraßen separate Linien zur Markierung erzeugen                                                  # noqa # TODO
proc_traffic_calming = 0     #   # Straßeneigenschaften auf Verkehrsberuhigungsmaßnahmen übertragen                                            # noqa # TODO
proc_cycleways       = 0     #   # Radwege nachbearbeiten                                                                                      # noqa # TODO
proc_path_areas      = 0     #   # Vereinigt aneinander angrenzende Wegeflächen und erzeugt deren Outlines                                     # noqa # TODO
proc_building_parts  = 0     # < # Gebäudeteile auf Stockwerksunterschiede auflösen, Gebäudegrundrisse / schwebende Gebäudeteile verarbeiten   # noqa # TODO
proc_housenumbers    = 0     #   # Hausnummern gleichmäßig zum Gebäudeumriss ausrichten                                                        # noqa # TODO
proc_water_body      = 0     # < # Gewässerkörper zu einem Einzelpolygon vereinigen                                                            # noqa # TODO
proc_landcover       = 0     #   # Bereiche mit "landcover=*" in Polygone umwandeln (werden nur als Linien erkannt)                            # noqa # TODO
proc_playground      = 0     #   # Gras-Flächen zur besseren Darstellung aus playground-Polygonen ausstanzen                                   # noqa # TODO
proc_orient_man_made = 0     # < # Richtet bestimmte Straßenmöbel zur nächstgelegenen Straße hin aus (Straßenlaternen, Schaltkästen)           # noqa # TODO
proc_trees           = 0     # < # Baumkronendurchmesser und Stammumfang abschätzen                                                            # noqa # TODO
proc_forests         = 0     #   # Waldbäume über ein hexagonales Gitter interpolieren                                                         # noqa # TODO
proc_cars            = 0     #   # Fahrzeuge auf Parkstreifen mit Farben und Fahrzeugmodellen generieren                                       # noqa # TODO
proc_labels          = 0     #   # bessere Segmente zur Beschriftung von Straßennamen und Gewässern generieren                                 # noqa # TODO
...
if proc_cr_markings:
    ...
    QgsVectorFileWriter.writeAsVectorFormat(layer_crossing_buffer_markings, proc_dir + 'crossing_buffer_markings.geojson', 'utf-8', QgsCoordinateReferenceSystem(crs_from), 'GeoJson')
